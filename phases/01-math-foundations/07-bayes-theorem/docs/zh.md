...
3. **添加功能。** 扩展 NaiveBayes 类，以将消息长度（短/长）与字数一起用作功能。根据训练数据估计 P(short|spam) 和 P(short|ham) 并将其折叠到预测分数中。
...
- [3Blue1Brown：贝叶斯定理](https://www.youtube.com/watch?v=HZGCoVF3YvM) - 带有医学测试示例的视觉解释
